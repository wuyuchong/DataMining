---
title: "主成分与偏最小二乘回归的效果对比"
description: "Comparison of the effects of principal components and partial least squares regression"
author: Jingyi Ma(编写), Yuchong Wu(整理)
date: 2020-04-17
categories: ["Python", "主成分回归", "偏最小二乘回归", "变量选择"]
tags: ["Python", "主成分回归", "偏最小二乘回归", "变量选择"]
