...
\textsc{\Large 数据挖掘课程}\\[0.5cm] % Minor heading such as course title
...
\HRule \\[0.4cm]
{ \huge \bfseries 代码文档}\\[0.4cm] % Title of your document
\HRule \\[1.5cm]
...
\textsc{\large 2017310836}\\[0.5cm] % Minor heading such as course title
\textsc{\large wuyuchong.com}\\[0.5cm] % Minor heading such as course title
\textsc{\large 指导老师：马景义}\\[0.5cm] % Minor heading such as course title
\end{center}
